...
//Instanriar Clase
$datolAlDia = new ViajesReales($date, $date);
						...
						<div class="row">
							...
							<script>
								...
								options: {
									...
									plugins: {
										// Aquí van las opciones para los plugins
										datalabels: {
											color: 'white',
											font: {
											size: 18
							...
							<div class="card mb-4">
								...
								<div class="card-body px-0 pt-0 pb-2">
									<div class="table-responsive p-0">
										<table class="table align-items-center justify-content-center mb-0 display" id="example" style="width:100%">
											<thead>
												<tr>
													<th class=" text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Tracto</th>
